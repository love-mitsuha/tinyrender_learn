...
template <typename Shader> void rasterize_depth(Shader shader, TGAImage& image, float* zbuffer)
{
	Vec3f screen_coords[3];
	for (int i = 0; i < 3; i++)
	{
...
template <typename Shader> void rasterize_shadow(Shader shader, TGAImage& image, float* zbuffer, float* shadowbuffer)
{
	Vec3f screen_coords[3];
	for (int i = 0; i < 3; i++)
	{
